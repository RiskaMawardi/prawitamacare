...
Route::group(['middleware' => ['auth', 'ceklevel:admin']], function () {
 ...
 //Route::group(['middleware' => ['auth', 'ceklevel:bendahara,admin']], function () {
   ...
   // Route::get('/kategori', 'KategoriController@index')->name('kategori');
    //Route::get('/create/kategori', 'KategoriController@create')->name('kategoricreate');
    //Route::post('/kategori/store', 'KategoriController@store')->name('kategorisave');
   // Route::get('/kategori/edit/{id}', 'KategoriController@edit')->name('kategoriedit');
    //Route::post('/kategori/update/{id}', 'KategoriController@update')->name('kategoriupdate');
    //Route::get('/kategori/hapus/{id}', 'KategoriController@destroy')->name('kategorihapus');
